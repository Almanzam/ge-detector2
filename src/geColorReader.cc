...
void geColorReader::ExtensionRead(const xercesc::DOMElement* const extElement)
{
        ...
        iter != 0; iter = iter->getNextSibling())
   {
      ...
      else
      {
        ...
        G4Exception("geColorReader::ExtensionRead()",
...
void geColorReader::VolumeRead(const xercesc::DOMElement* const volumeElement)
{
   G4VSolid* solidPtr = 0;
...
void geColorReader::ColorRead(const xercesc::DOMElement* const colorElement)
{
   G4String name;
...
G4VisAttributes* geColorReader::GetVisAttribute(const G4String& ref)
{
  ...
  else
  {
    ...
    G4Exception("geColorReader::GetVisAttribute()",
