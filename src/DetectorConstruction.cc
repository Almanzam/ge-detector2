...
G4VPhysicalVolume *DetectorConstruction::Construct()
{
    ...
    Ge_Crystal_logical->SetVisAttributes(G4Color(0, 1, 0, 1));
    ...
    Copper_Cup_logical->SetVisAttributes(G4Color(1,0,0,1));
...
//     Shell_logical->SetVisAttributes(G4Color(1,1,1,.5));
...
//     Mylar_Foil_logical->SetVisAttributes(G4Color(0,0,1,1));
...
//     Al_Foil_logical->SetVisAttributes(G4Color(1,1,0,1));
...
//     Ge_Li_Layer_logical->SetVisAttributes(G4Color(1,0,1,1));
...
//     Ge_B_Layer_logical->SetVisAttributes(G4Color(.5,.5,.2,1));
